    ...
    echo "
          <script>
            ...
            function checkUpdateInfo(){
              if(nickname != author){
                alert('수정 권한이 없습니다!');
                location.href = 'http://localhost/HTML/bbs/bbs.php?placename={$placename}&title={$row2['title']}';
              } else{
                
                location.href = 'http://localhost/HTML/bbs/bbs.php?placename={$placename}&title={$row2['title']}&mode=update';
              }
            }
