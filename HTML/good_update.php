...
$sql = "select * from good_data where 
...
if($row['click_user'] == ''){
  echo '1';
  $insert_sql = "
  INSERT INTO good_data(click_user, placename, title, content_idx, good) 
  VALUES (
  ...
  $sql2 = "select * from bbs_main where idx='{$data['jsonDataArray']['idx']}'";
